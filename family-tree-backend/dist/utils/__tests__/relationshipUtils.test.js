...
const relationshipUtils_1 = require("../relationshipUtils");
describe('RelationshipUtils', () => {
    const mockPerson = (overrides = {}) => ({
    ...
    describe('createPerson', () => {
        it('should create a person with generated ID and timestamps', () => {
            ...
            const person = relationshipUtils_1.RelationshipUtils.createPerson(input);
    ...
    describe('updateFullName', () => {
        it('should update full name and timestamp', () => {
            ...
            setTimeout(() => {
                const updatedPerson = relationshipUtils_1.RelationshipUtils.updateFullName(person);
    ...
    describe('addChildRelationship', () => {
        it('should add child to parent and parent to child', () => {
            ...
            const result = relationshipUtils_1.RelationshipUtils.addChildRelationship(parent, child);
    ...
    describe('removeChildRelationship', () => {
        it('should remove child from parent and parent from child', () => {
            ...
            const result = relationshipUtils_1.RelationshipUtils.removeChildRelationship(parent, child);
    ...
    describe('validateParentCount', () => {
        it('should return true for person with 0 parents', () => {
            ...
            expect(relationshipUtils_1.RelationshipUtils.validateParentCount(person)).toBe(true);
        });
        ...
        it('should return false for person with more than 2 parents', () => {
            ...
            expect(relationshipUtils_1.RelationshipUtils.validateParentCount(person)).toBe(false);
        });
    });
    describe('hasCircularRelationship', () => {
        it('should detect direct circular relationship', () => {
            ...
            const hasCircular = relationshipUtils_1.RelationshipUtils.hasCircularRelationship(persons, 'person2', 'person1');
        ...
        it('should detect indirect circular relationship', () => {
            ...
            const hasCircular = relationshipUtils_1.RelationshipUtils.hasCircularRelationship(persons, 'person3', 'person1');
            expect(hasCircular).toBe(true);
        });
        it('should return false for valid relationships', () => {
            ...
            const hasCircular = relationshipUtils_1.RelationshipUtils.hasCircularRelationship(persons, 'parent', 'child');
    ...
    describe('getDescendants', () => {
        it('should return all descendants', () => {
            ...
            const descendants = relationshipUtils_1.RelationshipUtils.getDescendants(persons, 'grandparent');
    ...
    describe('getAncestors', () => {
        it('should return all ancestors', () => {
            ...
            const ancestors = relationshipUtils_1.RelationshipUtils.getAncestors(persons, 'child');
    ...
    describe('validateTreeIntegrity', () => {
        it('should return valid for a well-formed tree', () => {
            ...
            const result = relationshipUtils_1.RelationshipUtils.validateTreeIntegrity(persons);
...
//# sourceMappingURL=relationshipUtils.test.js.map